...
#path="/home/user/Documents/Course Books/FML/Project/Hierarchical_Classification/Datasets/cat_hier_DMOZ.txt"
path="/home/user/Documents/Course Books/FML/Project/Hierarchical_Classification/Datasets/trial_hier.txt"
f = open(path, 'r')
ctr=0
lines=f.readlines()
for line in lines:
